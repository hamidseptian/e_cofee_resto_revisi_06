...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      elseif ($level=='Toko') { 
        if ($status!=1) { ?>
          <li class="header">Menu di nonaktifkan <br>Karena status toko anda <?php echo $status_toko[$status] ?></li>
        <?php }else{?>
         <li class="header">Main Navigation</li>
    ...
    where produk.id_toko='$id_toko_karyawan' and pesanan.status_pesanan in ('Order') group by pesanan.id_pelanggan, pesanan.tanggal_pesan");
    ...
    ?>
        ...
        <li><a href="?m=banner"><i class="fa fa-book"></i> <span style="color:aqua">Banner Toko</span></a></li>
          ...
          <a href="#">
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
              <span class="label label-primary pull-right"><?php echo $j1 ?> Baru</span>
            </span>
          </a>
          <ul class="treeview-menu">
