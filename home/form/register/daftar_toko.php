<div class="well">
	...
	<form class="form-horizontal" action="form/register/simpan_toko.php" method="post">
		...
		<div class="controls">
		<select class="form-control" required style="width:500px" name="jenis">
		...
		<div class="control-group">
			<label class="control-label" for="inputFname1">Nama Toko <sup>*</sup></label>
			<div class="controls">
			  <input type="text" name="nama" class="form-control" required style="width:500px">
			</div>
		 </div>
		<div class="control-group">
			<label class="control-label" for="inputFname1">Pemilik <sup>*</sup></label>
			<div class="controls">
			  <input type="text" name="pemilik" class="form-control" required style="width:500px">
			</div>
		 </div>
