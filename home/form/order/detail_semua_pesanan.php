...
<ul class="breadcrumb">
    ...
    <br>
    <a href="form/order/print_riwayat_pemesanan.php?waktu=<?php echo $waktu_pesan ?>&id_pelanggan=<?php echo $id_pelanggan ?>" class="btn btn-info btn-sm">Print Riwayat Pemesanan</a>
